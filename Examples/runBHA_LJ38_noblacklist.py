...
#Setup the BHA
cluster_makeup = {'Ne':38} 	#{'<Element Symbol>': <number of atoms>}
...
boxtoplaceinlength = 4.1 	#cube dimension for randomly generating a structure (used for reseeding and starting seed strucure).
...
target_energies=[-173.93, -173.25] 	#List of target energies (here the GM and Ih minimum of LJ38 are listed).
