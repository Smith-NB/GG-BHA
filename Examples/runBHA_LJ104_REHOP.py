...
search_strategy = 'energy_and_forbidden_hops' 	# 'energy' or 'energy_and_forbidden_hops' (the latter is the REHOP mode).
...
#pass search strategy (Metropolis Criterion) information to the BHA. Below is an example of the Energy and REHOP search strategy.
#the 'sim_cut' entry defines σ_BL, which defines the size of the taboo region around the blacklist.
search_strategy_information = {'search_strategy': search_strategy, 
