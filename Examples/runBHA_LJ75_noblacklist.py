...
#Setup the BHA
cluster_makeup = {'Ne':75} 		#{'<Element Symbol>': <number of atoms>}
...
boxtoplaceinlength = 4.9 	#cube dimension for randomly generating a structure (used for reseeding and starting seed strucure).
...
target_energies=[-397.49, -396.28] 	#List of target energies (here the GM and Ih minimum of LJ75a are listed).
